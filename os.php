...
?>
<body style="height:1300px;background-image: url(zdj/tlognig.jpg);background-size: 100% 100%;">
...
<div class="container-fluid">
	...
	<div class="os1 container">
		<img class="img-fluid" src="zdj/os.jpg" alt="os">
	</div>
	<div class="cale container">
		<br><p><b>Biuro Projektów „Nafta-Gaz” Sp. z o.o. świadczy usługi projektowe dla inwestycji związanych z wykorzystaniem i ochroną środowiska naturalnego, zgodnie z najnowszymi standardami. Dotyczą one głównie przedsięwzięć polegających na zagospodarowywaniu i przetwarzaniu odpadów, ograniczaniu emisji zanieczyszczeń powietrza atmosferycznego i emisji hałasu oraz ochronie wód powierzchniowych, podziemnych i środowiska gruntowego. Spółka posiada wieloletnie doświadczenie w zakresie wykonywania ocen, raportów i innych opracowań związanych z oddziaływaniem przedsięwzięć na środowisko. Wykonujemy kompleksową dokumentację projektową dla obiektów takich jak:</b></p>
		<div class="container">
      <ul>
			<li>zakłady mechaniczno-biologicznego przetwarzania odpadów komunalnych</li>
			<li>składowiska odpadów komunalnych i przemysłowych</li>
			<li>oczyszczalnie ścieków bytowo-gospodarczych</li>
			<li>oczyszczalnie ścieków przemysłowych</li>
			<li>przepompownie ścieków</li>
			<li>ujęcia wód powierzchniowych i podziemnych</li>
			<li>zabezpieczenia instalacji przemysłowych przed emisją hałasu do środowiska</li>
			<li>powierzchniowe i podziemne zbiorniki wodne</li>
			<li>zamykanie, likwidacja i rekultywacja składowisk odpadów komunalnych</li>
			<li>odwadnianie terenów</li>
      <li>sieci kanalizacyjne</li>
    </ul>
			<br>
		</div>
	<div class="container">
		<p><b>Dla obiektów związanych z wykorzystaniem i ochroną środowiska naturalnego oferujemy kompleksowe usługi projektowe obejmujące wszystkie etapy realizacji inwestycji:</b></p>
	</div>
	<div class="container">
    <ul>
		...
		<li>Uzyskanie wymaganych prawem pozwoleń związanych z eksploatacją obiektów</li>
		<li>Pełnienie obowiązków inżyniera projektu w trakcie realizacji inwestycji</li>
  </ul>
		<br><br>
	</div>
</div>
