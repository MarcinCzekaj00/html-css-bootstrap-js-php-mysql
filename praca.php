...
?>
<body style="height:1100px;background-image: url(zdj/tlognig.jpg);background-size: 100% 100%;">
...
<div class="praca container-fluid">
	<div class="container-fluid" style="margin-top: 150px">
	</div>
	<div class="os1 container">
		<img class="img-fluid" src="zdj/unnamed.jpg" alt="unnamed">
	</div>
	<div class="tekst1 container">
		<br><p style="text-align: center;font-size: 25px"><b>CHCESZ DO NAS DOŁACZYĆ?</b></p>
		<br>
		<p style="text-align: center;font-size: 20px">Dobrze trafiłeś!</p><br>
		<p style="text-align: left;font-size: 20px"> Aktualnie prowadzimy rekrutacje na następujące stanowiska:</p>
    <ul>
		<li>Projektant instalacji gazowych <img class="img-fluid" src="zdj/gaz.png" alt="gaz" width=30></li>
		<li>Ekspert ds. ekonomii <img class="img-fluid" src="zdj/ekonomia.png" alt="ekonomia" width=40></li>
		<li>Technik elektryk <img class="img-fluid" src="zdj/ele.png" alt="ele" width=30></li>
		<li>Projektant układów gazowych <img class="img-fluid" src="zdj/gaz.png" alt="gaz" width=30></li>
  </ul>
		<br><br>
		<p style="text-align: left;font-size: 30px"> Jeśli chcesz do nas dołączyć <a href="strona.php#kontakt" style="font-size: 35px"> skontaktuj się z nami!</a></p>
		<br><br>
	</div>
</div>
