...
<div class="container" style="padding-top: 150px;padding-left: 50px">
    ...
    <b>Podaj login:</b> <input type="text" name="login" required>
    <br><br>
    <b>Podaj hasło:</b> <input type="password" name="haslo" required>
    <br><br>
	<b>Adres e-mail:</b> <input type="text" name="email" required>
    <br><br>
